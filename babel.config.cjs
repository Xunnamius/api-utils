...
function getBabelAliases() {
  ...
  return {
    ...
    '^multiverse\\+next\\x2denv:(.+)$': './packages/env/src/$1',
    ...
    '^multiverse\\+next\\x2denv$': './packages/env/src/index.js',
    ...
    '^universe\\+next\\x2denv:(.+)$': './packages/env/src/$1',
    ...
    '^universe\\+next\\x2denv$': './packages/env/src/index.js',
    ...
    '^testverse\\+next\\x2denv:(.+)$': './packages/env/test/$1',
    ...
    '^rootverse\\+next\\x2denv:(.+)$': './packages/env/$1',
