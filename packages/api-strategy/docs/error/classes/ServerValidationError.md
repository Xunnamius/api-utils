...
Defined in: [packages/api-strategy/src/error.ts:41](https://github.com/Xunnamius/api-utils/blob/4b9cf49c1b8ec6d8960c6a16e9e497be226b121a/packages/api-strategy/src/error.ts#L41)
...
> **new ServerValidationError**(`message?`): `ServerValidationError`
...
> **new ServerValidationError**(`message?`, `options?`): `ServerValidationError`
